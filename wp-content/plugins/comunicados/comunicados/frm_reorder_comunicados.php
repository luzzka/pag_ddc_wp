...
if ($conexion_i->conectar()) {
    $result = $conexion_i->lista_comunicados_publicados();
    ...
    <html lang="es-ES">
    <head>
        <title>Reordenamiento de Comunicados</title>
    ...
    <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
        ...
        <div class="mdl-grid">
            ...
            <form action="registro_orden_comunicados.php" class="mdl-cell mdl-cell--10-col mdl-cell--6-col-tablet mdl-color--white mdl-shadow--2dp" method="post">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = mysqli_fetch_row($result)) { ?>
                                    <tr class="selection">
                                        ...
                                        <td style="text-align: center"><strong><?php echo $row[1] ?></strong></td>
