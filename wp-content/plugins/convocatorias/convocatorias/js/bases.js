...
$('#add-base').click(function (e) {
    ...
    window.location = "../convocatorias/crear_base.html";
});

$('#ordenar-base').click(function (e) {
    e.preventDefault();

    window.location = "../convocatorias/frm_reorder_bases.php";
});

var tablaBases = jQuery('.tablaBases');

// Publicar
tablaBases.find('button.publicado').click(function () {
    var id = $(this).parent().parent().attr('data-id');

    window.location = "../convocatorias/base_pub.php?id_base="+id;
    console.log(id);
});
...
tablaBases.find('button.editar').click(function () {
    ...
    window.location = "../convocatorias/frm_editar_base.php?id_base="+id;
    // console.log(id);
});
