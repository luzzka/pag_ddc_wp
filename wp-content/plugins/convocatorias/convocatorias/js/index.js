...
$('#add-convocatoria').click(function (e) {
    ...
    window.location = "../convocatorias/crear.html";
});

var tablaConvocatorias = jQuery('.tablaConvocatorias');

// Editar Convocatoria
tablaConvocatorias.find('button.editar').click(function () {
    var id = $(this).parent().parent().attr('data-id');

    window.location = "../convocatorias/frm_editar_conv.php?id_convocatoria="+id;
    // console.log(id);
});

// Eliminar Convocatoria
tablaConvocatorias.find('button.eliminar[type=submit]').click(function (e) {
    e.preventDefault();
    var boton = $(this);
...
tablaConvocatorias.find('[data-tooltip]') // encontrar elementos con el atributo 'data-tooltip'
    .each(function (i, e) {
