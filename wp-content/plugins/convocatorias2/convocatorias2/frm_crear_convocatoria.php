...
<div class="mdl-grid">
	...
	<form id="formulario" action="store_new_convocatoria.php" class="mdl-cell mdl-cell--6-col mdl-cell--6-col-tablet mdl-color--white mdl-shadow--2dp" enctype="multipart/form-data" method="post">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-control-wrapper">
						<input type="text" id="date" name="date" class="form-control floating-label" placeholder="Fecha">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
			...
			<ul for="estado" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
				<li class="mdl-menu__item" data-val="0" data-selected="true">Vigente</li>
				<li class="mdl-menu__item" data-val="1">Finalizada</li>
			</ul>
		</div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
			...
			<ul for="publicado" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
				<li class="mdl-menu__item" data-val="0" data-selected="true">No Publicado</li>
				<li class="mdl-menu__item" data-val="1">Publicado</li>
			</ul>
		</div>
