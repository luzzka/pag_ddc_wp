...
if ($conexion_i->conectar()) {
	...
	$result = $conexion_i->getdata_docs_fde($id_convocatoria);
...
<div class="mdl-grid">
	...
	<form id="formulario" action="actualiza_fde.php" class="mdl-cell mdl-cell--8-col mdl-cell--6-col-tablet mdl-color--white mdl-shadow--2dp" enctype="multipart/form-data" method="post">
