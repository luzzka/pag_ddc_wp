// Add Disposicion
$('#add-disposicion').click(function (e) {
    e.preventDefault();

    window.location = "crear.html";
});

// Ordenar Disposiciones
$('#ordenar-disposiciones').click(function (e) {
    e.preventDefault();
    ...
    window.location = "frm_reorder_disposiciones.php?tipo="+tipo+"&ano="+ano;
});

var tabla = jQuery('.tablaDisposiciones');
...
tabla.find('button.editar').click(function () {
    ...
    window.location = "frm_editar.php?id="+id;
    // console.log(id);
});
