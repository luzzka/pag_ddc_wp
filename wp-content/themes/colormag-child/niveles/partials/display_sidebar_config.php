...
<div class="mkcontainer">
	<h1 class="prin">Configuración sidebar</h1>
						...
						<form action="" method="post">
							...
							<table class="widefat">
								<thead>
									<tr>
										<th colspan="2">
											<div class="tableTitle tableEditNew"><?php echo ucfirst($action) ?> sidebar</div>
								...
								<tr class="<?php if( $action == 'nuevo' ) echo 'mkhidden'; ?> mkslidertable">
									<th><span class="lft">Sidebar</span></th>
									<td>
										<button class="button-primary bu_editar_side mkbutton">Editar</button>
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<td>
										...
										<?php if( $action == 'editar' ): ?>
											<button type="button" class="button buEliminarSidebar" data-iden="<?php echo $id_slider ?>">Eliminar</button>
										<?php endif; ?>
									</td>
								</tr>
					...
					<div class="formSlider">
						<table class="widefat">
							...
							<tr>
								...
								<td>
									...
									<div class="mkaddimage">
										...
										<p class="howto">Recomendado 220 x 72</p>
									</div>
							...
							<tr>
								<th>&nbsp;</th>
								<td>
									<button type="button" class="button butActionSidebar">Crear</button>
									<button type="button" class="button butCancelEditarSidebar mkhidden">Agregar m&aacute;s</button>
								</td>
							</tr>
						</table>
					</div>
			...
			<div class="mkright">
				<div class="mkctn">
					<div class="listadoItems">
						<p class="mensajeCentral">No hay elementos en el sidebar.</p>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
  jQuery(document).ready(function($){
    ...
    $('#agregar_imagen, #mk_imagen_muestra').click(function(e) {
      e.preventDefault();
      var image = wp.media({
        title: 'Seleccionar imagen sidebar 220 x 72',
